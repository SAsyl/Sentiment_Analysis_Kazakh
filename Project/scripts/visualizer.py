...
def plot_word_clouds(pos_df, neg_df, n_top_words, type):
    ...
    if type == 'wordcloud':
        plt.savefig(f"./../results/wordcloud/pos_neg_raw{n_top_words}.png")
    elif type == 'classifier':
        plt.savefig(f"./../results/classifier/pos_neg_lemmatized{n_top_words}.png")
